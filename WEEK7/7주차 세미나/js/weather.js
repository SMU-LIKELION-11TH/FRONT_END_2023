const API_KEY = "3e93556c1ebc90051853fb52889eda18"
...
const callbackOk = (position) => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&units=${units}&appid=3e93556c1ebc90051853fb52889eda18`
    fetch(url)
