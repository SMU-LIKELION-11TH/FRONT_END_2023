...
const callBackOk = (position) => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&units=${units}&appid=ee1cb8e0666c163459a4157c03f42daf`;
    ...
    fetch(url)
        ...
        .then((data) => {
            ...
            wind.innerText = `${temperature} ${data.wind.speed}m/s`;
