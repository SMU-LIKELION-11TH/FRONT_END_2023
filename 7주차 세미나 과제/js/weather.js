const API_KEY = "22350ab97d67c11a42a2e38499af6f85";
...
const callbackOk = (position) => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&units=${units}&appid=22350ab97d67c11a42a2e38499af6f85`
