const API_KEY = "{f76f07a27564404f996b5b2c6af0e346}";
...
const callbackOK = (position) => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&units=${units}&appid=f76f07a27564404f996b5b2c6af0e346`;
