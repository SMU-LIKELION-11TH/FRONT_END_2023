const API_KEY = "{5126a0988289e692a07df0a862e05d68}"
...
const callbackOk = (position) => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&units=${units}&appid=5126a0988289e692a07df0a862e05d68`;
    // console.log(url)
    fetch(url)
